...
public class CompatTextureView extends TextureView {
    ...
    public CompatTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CompatTextureView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (videoWidth > 0 && videoHeight > 0) {
            ...
            LogUtils.d("Test", "widthSpecMode = " + widthSpecMode + "  heightSpecMode = " + heightSpecMode);
